  ...
  if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS') {
    ...
    $currLastLogged = "";
        ...
        $currLastLogged = $curr_user['DateLastLoggedIn'];
                ...
                $stmt = $conn->prepare("INSERT into Contacts (DateCreated, DateLastLoggedIn, FirstName,LastName,Phone,Email,UserID,Avatar) VALUES ('$date','$currLastLogged','$firstName','$lastName','$phoneNumber','$email','$curr_ID','$avatar')");
    if($stmt->execute())
    {
